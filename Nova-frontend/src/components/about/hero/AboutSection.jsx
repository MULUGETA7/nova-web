...
import OverlappingText from "./OverlappingText";

const AboutSection = () => {
  return (
    <section className="flex overflow-hidden flex-col justify-center items-center  w-full max-md:px-5 max-md:max-w-full">
      <div className="flex-1 px-9 py-24 w-full w-full max-md:px-5 max-md:max-w-full">
      <section className="box-border mt-0 md:mt-[-80px] w-full flex flex-col md:flex-row relative px-9 py-0 mx-auto my-0 w-full  max-md:px-5 max-md:py-0 max-md:h-auto max-sm:px-4 max-sm:py-0">
    ...
    <article className="flex flex-col w-full md:w-1/3 ml-auto  ">
      ...
      Nova Labs is a collective of thinkers, builders, designers, and disruptors.
      We specialize in digital transformation — helping businesses of all sizes thrive through strategic design, intelligent development, and immersive branding.
      </p>
        ...
        <figure className="mt-9 px-20 w-full">
          <img
            src="https://cdn.builder.io/api/v1/image/assets/c95d7ed1b46245fe99ca63e5b9b593ad/e539be07ad63cfb4147c53428f893fcbca42ca30?placeholderIfAbsent=true"
            alt="Celeron agency showcase"
            className="object-contain w-full rounded-2xl aspect-[2.19] max-md:max-w-full"
          />
        </figure>
      </div>
    </section>
