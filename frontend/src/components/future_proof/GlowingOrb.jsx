...
function GlowingOrb() {
  return (
    <div className="relative mx-auto w-full md:w-[90%] lg:w-[85%] aspect-square scale-[1.4] md:scale-100">
      ...
      {/* Orbits */}
      <div className="flex absolute justify-center items-center bottom-[-100px] left-[-114px] right-[-164px] top-[-180px]">
        <InnerOrbit />
      </div>
      <div className="flex absolute justify-center items-center bottom-[-230px] left-[-227px] right-[-277px] top-[-310px]">
        <OutlineOrbit />
      </div>
    </div>
  );
